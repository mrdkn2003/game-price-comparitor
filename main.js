...
document.addEventListener('DOMContentLoaded', () => {
  const basicGames = games.filter(game => game.type === 'basic');
  const container = document.getElementById('game-list');

  basicGames.forEach(game => {
    ...
    card.innerHTML = `
      ...
      <div class="game-info">
        ...
        <p><strong>Steam:</strong> <a href="${game.steamLink}" target="_blank">${game.steamPrice}</a></p>
        <p><strong>Epic:</strong> <a href="${game.epicLink}" target="_blank">${game.epicPrice}</a></p>
